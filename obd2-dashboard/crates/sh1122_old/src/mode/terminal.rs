...
use crate::{
    consts::{NUM_PIXEL_COLS, NUM_PIXEL_ROWS},
...
impl Cursor {
    pub fn new(width_pixels: u16, height_pixels: u8) -> Self {
...
impl<DI> DisplayConfig for Display<DI, TerminalMode>
where
...
impl<DI> Display<DI, TerminalMode>
where
    DI: WriteOnlyDataCommand,
{
    ...
    pub fn clear(&mut self) -> Result<(), TerminalModeError> {
        ...
        let offset_x = match self.rotation {
            ...
            DisplayRotation::Rotate180 => {
                ...
                NUM_PIXEL_COLS - NUM_PIXEL_ROWS as u16
            }
        };
        //TODO
        //self.set_draw_area((offset_x, 0), (NUM_PIXEL_COLS + offset_x, NUM_PIXEL_ROWS))
        //    .terminal_err()?;
    ...
    pub fn position(&self) -> Result<(u16, u8), TerminalModeError> {
        self.mode
            .cursor
            .as_ref()
    ...
    pub fn set_position(&mut self, column: u16, row: u8) -> Result<(), TerminalModeError> {
        ...
        if column >= width || row >= height {
            ...
            match self.rotation {
                DisplayRotation::Rotate0 | DisplayRotation::Rotate180 => {
                    ...
                    //self.set_row(row * 8).terminal_err()?;
                }
            }
...
impl<DI> core::fmt::Write for Display<DI, TerminalMode>
where
    DI: WriteOnlyDataCommand,
{
