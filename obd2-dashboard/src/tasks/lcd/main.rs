...
impl LcdMainState {
    ...
    pub fn update_bms_pid(&mut self, bms_pid: &BmsPid) {
        ...
        //max power is around ~40kW
        let power = bms_pid.hv_battery_current * bms_pid.hv_dc_voltage;
        self.electric_power_arrow.update_speed(power as f64 / 40000.0 * 100.0);
        self.electric_power.update_power(power);
