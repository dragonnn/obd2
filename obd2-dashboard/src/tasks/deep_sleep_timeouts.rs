...
pub const CAR_OPEN: Duration = Duration::from_secs(10 * 60);
...
pub const INCOMPLETE_OBD2_LOOP: Duration = Duration::from_secs(10 * 60);
...
pub const FALLBACK: Duration = Duration::from_secs(20 * 60);
