#ifndef _MCP2515v2_H_
#define _MCP2515v2_H_
...
private:
  ...
  void setRegisters(const REGISTER reg, const uint8_t values[],
                    const uint8_t n);
...
public:
  MCP2515v2(const uint8_t _CS, const uint32_t _SPI_CLOCK = DEFAULT_SPI_CLOCK,
