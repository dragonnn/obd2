...
static int co6300_backlight_update_status(struct backlight_device *backlight)
{
...
static const struct backlight_ops co6300_backlight_ops = {
	.update_status = co6300_backlight_update_status,
};
...
static int co6300_probe(struct mipi_dsi_device *dsi)
{
	...
	ctx->backlight = devm_backlight_device_register(&dsi->dev, "co6300",
						&dsi->dev, ctx,
						&co6300_backlight_ops,
